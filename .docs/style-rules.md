...
- Apply the token to the single element that immediately follows the heading. Do not add a competing top margin on a wrapper — the `mt-4` gap lives in the token.
