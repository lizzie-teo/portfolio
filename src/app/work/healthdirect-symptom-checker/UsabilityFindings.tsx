import type { Feature } from "@/app/components/FeatureChips";
 ...
 * unrelated evidence widgets. This module owns only the data; page.tsx renders
 * the band and passes the section heading, lede, and tone.
 *
 ...
 */
export const usabilityFindings: Feature[] = [
  {
    id: "seek-urgent-care",
