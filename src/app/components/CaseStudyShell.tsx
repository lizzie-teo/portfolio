...
export function CaseStudyShell({ slug, intro, children }: CaseStudyShellProps) {
      ...
      <main className="overflow-x-clip">
        <div className="mx-auto w-full max-w-[1800px] px-4 pb-16 pt-3 sm:px-6 md:px-8 md:pt-4 lg:px-12 lg:pb-24 xl:px-16 xl:pb-32 2xl:px-24">
          <div className="xl:pr-64 2xl:pr-72">
            <section className="rounded-3xl bg-leaf px-5 py-12 sm:px-8 md:py-16 lg:px-12 lg:py-20">
              <div
                className={
                  intro
                    ? "grid gap-10 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] lg:items-end lg:gap-16 xl:gap-24"
                    : undefined
                }
              >
                <div className="min-w-0">
                  <p className="mb-5 text-xs font-medium uppercase tracking-[0.18em] text-leaf-foreground/70">
                    Case study
                  </p>
                ...
                {intro ? (
                  <div className="min-w-0 space-y-8">
                    ...
                    {intro.meta?.length ? (
                      <dl className="space-y-5 border-t border-leaf-foreground/20 pt-6">
                        {intro.meta.map((item) => (
                          <div key={item.label}>
